...
mis_imagenes = []
nombres_empleados = []
lista_empelados = os.listdir(ruta)

for nombre in lista_empelados:
...
if not exito:
    print('No fue posible tomar la captura')
else:
    ...
    for caracodif, caraubic in zip(cara_captura_codificada, cara_captura):
        coincidencia = fr.compare_faces(lista_empleado_codificada, caracodif)
        distancias = fr.face_distance(lista_empleado_codificada, caracodif)

        indice_coincidencia = numpy.argmin(distancias)

        #mostrr coincidencias
